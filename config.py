...
BOT_TOKEN = getenv("BOT_TOKEN", "7018409603:AAHqvNE5c1HBJNG7RPT9aZAa03QRO67EzNw")
...
LOG_GROUP = getenv("LOG_GROUP", "-1002198037301")
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1002278038477"))
